...
class S3PublicationRepository(IPublicationRepository):
    ...
    def base_prefix(schema_name: str, table_name: str, run_id: str) -> str:
        return f"{schema_name.strip('/')}/{table_name.strip('/')}/runs/{run_id.strip('/')}"
    ...
    @staticmethod
    def build_ddl_key(schema_name: str, table_name: str, run_id: str, engine_name: str) -> str:
        prefix = S3PublicationRepository.base_prefix(schema_name, table_name, run_id)
    ...
    def stage_artifacts(self, table_data: GeneratedTableData, run_id: str, ddl_queries: Dict[str, str]) -> TablePublication:
    ...
    def cleanup_run_artifacts(self, schema_name: str, table_name: str, run_id: str) -> None:
